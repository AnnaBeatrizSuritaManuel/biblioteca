...
// Buscar livros de aventura do banco
$livros_aventura = $pdo->prepare("
    SELECT * FROM LIVROS 
    WHERE genero LIKE '%aventura%' OR genero LIKE '%Aventura%' OR genero LIKE '%expedição%' OR genero LIKE '%exploração%'
    ORDER BY titulo
");
$livros_aventura->execute();
$livros = $livros_aventura->fetchAll();
?>
...
<head>
    ...
    <title>Aventura - Bibliotec</title>
        ...
        <section class="section">
            <div class="container">
                <div class="section-header">
                    <h2 class="section-title">Livros de Aventura</h2>
                ...
                <?php if(empty($livros)): ?>
                    <div class="text-center" style="padding: 3rem;">
                        ...
                        <p style="color: var(--text-secondary);">Nenhum livro de aventura cadastrado ainda.</p>
                        <?php if(isset($_SESSION['usuario_tipo']) && $_SESSION['usuario_tipo'] == 'admin'): ?>
                            <a href="admin/livros.php" class="btn btn-primary mt-2">Cadastrar Livros de Aventura</a>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
        ...
        function openBookModal(livroId) {
            const modalContent = `
                <div style="text-align: center; padding: 1rem;">
                    ...
                    <h4>Detalhes do Livro de Aventura</h4>
