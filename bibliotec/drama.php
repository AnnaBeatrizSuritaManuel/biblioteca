        ...
        <section class="section">
            <div class="container">
                <div class="section-header">
                    <h2 class="section-title">Livros de Drama</h2>
                    <p class="section-subtitle">Histórias emocionantes sobre conflitos humanos e superação</p>
                </div>
                
                <?php if(empty($livros)): ?>
                    <div class="text-center" style="padding: 3rem;">
                        <i class="fas fa-theater-masks" style="font-size: 3rem; color: var(--text-muted); margin-bottom: 1rem;"></i>
                        <p style="color: var(--text-secondary);">Nenhum livro de drama cadastrado ainda.</p>
                        <?php if(isset($_SESSION['usuario_tipo']) && $_SESSION['usuario_tipo'] == 'admin'): ?>
                            <a href="admin/livros.php" class="btn btn-primary mt-2">Cadastrar Livros de Drama</a>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
                    ...
                    <div class="card-body"></div>
                        <div class="card">
                            <img src="img/<?= $livro['titulo'] ?>.jpg" alt="<?= $livro['titulo'] ?>" class="card-img"
                                 onerror="this.src='data:image/svg+xml;base64,'">
                            <div class="card-body">
        ...
        <section class="section" style="background: var(--background);">
            <div class="container">
                <div class="grid grid-2">
                    <div>
                        <h3>Sobre o Gênero Drama</h3>
                        <p>O drama na literatura explora conflitos humanos profundos, relações sociais complexas e as emoções mais intensas da experiência humana. São histórias que nos fazem refletir sobre a condição humana.</p>
                        ...
                        <ul>
                            ...
                            <li>Superação pessoal e transformação</li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>O maior dramaturgo de todos os tempos, autor de "Hamlet" e "Romeu e Julieta".</p>
                            </div>
                        </div>
                        <div class="card mt-2">
                            <div class="card-body">
                                <h4>Fiodor Dostoiévski</h4>
                                <p>Mestre do drama psicológico, autor de "Crime e Castigo".</p>
                            </div>
                        </div>
                        <div class="card mt-2">
                            <div class="card-body">
                                <h4>Tennessee Williams</h4>
                                <p>Dramaturgo americano, autor de "Um Bonde Chamado Desejo".</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function openBookModal(livroId) {
            const modalContent = `
                <div style="text-align: center; padding: 1rem;">
                    <i class="fas fa-theater-masks" style="font-size: 4rem; color: var(--primary-main); margin-bottom: 1rem;"></i>
                    <h4>Detalhes do Livro de Drama</h4>
