...
<head>
    ...
    <title>Ficção Científica - Bibliotec</title>
        ...
        <section class="section">
            <div class="container">
                <div class="section-header">
                    ...
                    <p class="section-subtitle">Futuros distantes, tecnologia avançada e exploração espacial</p>
                </div>
                
                <?php if(empty($livros)): ?>
                    <div class="text-center" style="padding: 3rem;">
                        <i class="fas fa-rocket" style="font-size: 3rem; color: var(--text-muted); margin-bottom: 1rem;"></i>
                        <p style="color: var(--text-secondary);">Nenhum livro de ficção científica cadastrado ainda.</p>
                        <?php if(isset($_SESSION['usuario_tipo']) && $_SESSION['usuario_tipo'] == 'admin'): ?>
                            <a href="admin/livros.php" class="btn btn-primary mt-2">Cadastrar Livros de Ficção Científica</a>
                        <?php endif; ?>
                    </div>
                <?php else: ?>
                    ...
                    <div class="card-body"></div>
                        <div class="card">
                            <img src="img/<?= $livro['titulo'] ?>.jpg" alt="<?= $livro['titulo'] ?>" class="card-img"
                                 onerror="this.src='data:image/svg+xml;base64,'">
                            <div class="card-body">
        ...
        <section class="section" style="background: var(--background);">
            <div class="container">
                <div class="grid grid-2">
                    <div>
                        <h3>Sobre o Gênero Ficção Científica</h3>
                        <p>A ficção científica explora possibilidades futuras baseadas em avanços científicos e tecnológicos. Desde viagens espaciais até inteligência artificial, o gênero questiona o futuro da humanidade.</p>
                    ...
                    <div>
                        <h3>Autores Famosos</h3>
                        <div class="card">
                            <div class="card-body">
                                <h4>Isaac Asimov</h4>
                                <p>Criador das Três Leis da Robótica e da série Fundação.</p>
                            </div>
                        </div>
                        <div class="card mt-2">
                            <div class="card-body">
                                <h4>Philip K. Dick</h4>
                                <p>Autor de "Androides Sonham com Ovelhas Elétricas?" (Blade Runner).</p>
                            </div>
                        </div>
                        <div class="card mt-2">
                            <div class="card-body">
                                <h4>Frank Herbert</h4>
                                <p>Criador da épica saga "Duna".</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        function openBookModal(livroId) {
            const modalContent = `
                <div style="text-align: center; padding: 1rem;">
                    <i class="fas fa-rocket" style="font-size: 4rem; color: var(--primary-main); margin-bottom: 1rem;"></i>
                    <h4>Detalhes do Livro de Ficção Científica</h4>
