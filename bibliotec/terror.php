...
<head>
    ...
    <title>bibliotec - Livros de Terror</title>
...
<body>
    ...
    <main>
        <div class="terror-container">
            <h1>Terror & Horror</h1>
            <p class="subtitle">O terror vigia cada capítulo, esperando que você avance.</p>

            <!-- Lista de livros -->
            <div class="book-list">
                
                <div class="book-card" onclick="openModal('O Exorcista', 'William Peter Blatty', 'img/O exorcista.png', 'Inspirado em um caso real, o livro conta a história de uma menina possuída por uma entidade demoníaca e dos esforços de dois padres para realizar um exorcismo. É uma narrativa intensa, explorando medo, fé e possessão.', 'Terror sobrenatural')">
                    <img src="img/O exorcista.png" alt="Capa do Livro O Exorcista"> 
                    <h3>O Exorcista</h3>
                    <span class="author">William Peter Blatty</span>
                    <p style="color: var(--global-secondary); font-size: 0.95rem;">Terror sobrenatural</p>
                    <a href="javascript:void(0)" class="btn-primary" style="margin-top: 15px; width: 100%;">Ver Detalhes</a>
                </div>

                <div class="book-card" onclick="openModal('It: A Coisa', 'Stephen King', 'img/it.png', 'Uma história que alterna entre passado e presente, acompanhando um grupo de amigos que enfrenta uma entidade maléfica chamada "Pennywise", que se manifesta como um palhaço para aterrorizar crianças na cidade de Derry. Mistura elementos de horror, amizade e trauma.', 'Terror psicológico e sobrenatural')">
                    <img src="img/it.png" alt="Capa do Livro It: A Coisa">
                    <h3>It: A Coisa</h3>
                    <span class="author">Stephen King</span>
                    <p style="color: var(--global-secondary); font-size: 0.95rem;">Terror psicológico e sobrenatural</p>
                    <a href="javascript:void(0)" class="btn-primary" style="margin-top: 15px; width: 100%;">Ver Detalhes</a>
                </div>

                <div class="book-card" onclick="openModal('Drácula', 'Bram Stoker', 'img/dracula.png', 'Um clássico da literatura, conta a história do Conde Drácula e sua tentativa de expandir sua influência vampírica para a Inglaterra. É narrado em forma de diários, cartas e relatos, criando um clima envolvente e perturbador.', 'Terror gótico e sobrenatural')">
                    <img src="img/dracula.png" alt="Capa do Livro Drácula">
                    <h3>Drácula</h3>
                    <span class="author">Bram Stoker</span>
                    <p style="color: var(--global-secondary); font-size: 0.95rem;">Terror gótico e sobrenatural</p>
                    <a href="javascript:void(0)" class="btn-primary" style="margin-top: 15px; width: 100%;">Ver Detalhes</a>
                </div>

                <div class="book-card" onclick="openModal('Bird Box', 'Josh Malerman', 'img/bird.png', 'Em um mundo apocalíptico, uma força misteriosa leva as pessoas à loucura ao serem vistas. A protagonista vive em constante medo e precisa sobreviver vendada junto com seus filhos para escapar da ameaça invisível, em uma história tensa e claustrofóbica.', 'Terror psicológico')">
                    <img src="img/bird.png" alt="Capa do Livro Bird Box">
                    <h3>Bird Box</h3>
                    <span class="author">Josh Malerman</span>
                    <p style="color: var(--global-secondary); font-size: 0.95rem;">Terror psicológico</p>
                    <a href="javascript:void(0)" class="btn-primary" style="margin-top: 15px; width: 100%;">Ver Detalhes</a>
                </div>
            </div>
        </div>
    ...
    <footer>
        <p>&copy; 2025 bibliotec. Todos os direitos reservados. Feito com sombras. 🩸</p>
    </footer>
